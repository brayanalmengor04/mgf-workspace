...
<x-filament-panels::page>
    <style>
        .quote-template-preview-root {
            width: 100%;
            max-width: none;
        }

        .quote-template-preview-canvas {
            width: 100%;
            box-sizing: border-box;
        }

        .quote-template-preview-stage {
            display: flex;
            width: 100%;
            min-width: 0;
        ...
        .quote-template-preview-paper {
            flex-shrink: 0;
        }
    </style>

    <div
        class="quote-template-preview-root"
        x-data="{
            paperWidth: 816,
            paperHeight: 1056,
            scale: 1,
    ...
    >
        <p class="mb-4 max-w-3xl text-sm text-gray-500 dark:text-gray-400">
            Vista previa con datos de ejemplo. Usa el estilo, color y logo <strong>guardados</strong> de esta plantilla.
            Si acabas de cambiar el diseño, guarda antes de previsualizar.
        </p>

        <div
            x-ref="canvas"
            class="quote-template-preview-canvas overflow-auto rounded-xl border border-gray-200 bg-zinc-300/90 p-6 dark:border-gray-700 dark:bg-zinc-900/90"
            style="max-height: calc(100vh - 14rem);"
        >
            <div class="quote-template-preview-stage">
                <div
                    class="quote-template-preview-paper overflow-hidden rounded-sm bg-white shadow-2xl ring-1 ring-black/10"
